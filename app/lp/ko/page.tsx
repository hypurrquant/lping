              ...
              return (
                <div style={{ 
                  ...
                  <div style={{ fontSize: 13, color: theme.textSecondary }}>
                    {activePositions.length}개 활성 포지션
                  </div>
                </div>
              );
            })()}
            ...
            {(() => {
              ...
              return (
                <div style={{ 
                  ...
                  <div style={{ fontSize: 13, color: theme.textSecondary }}>
                    {stakedPositions.length}개 스테이킹 포지션
                  </div>
                </div>
              );
            })()}
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
              ...
              <h2 style={{ fontSize: 18, fontWeight: 700, color: theme.success, margin: 0 }}>
                전체 스테이킹 보상 ({stakedPositions.length}개 활성 포지션)
              </h2>
            </div>
            
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }}>
              <div style={{ padding: 12, background: theme.bgCard, borderRadius: 8, border: `1px solid ${theme.border}` }}>
                <div style={{ fontSize: 12, color: theme.textSecondary, marginBottom: 4 }}>초당</div>
              ...
              <div style={{ padding: 12, background: theme.bgCard, borderRadius: 8, border: `1px solid ${theme.border}` }}>
                <div style={{ fontSize: 12, color: theme.textSecondary, marginBottom: 4 }}>일당</div>
                <div style={{ fontSize: 20, fontWeight: 700, color: theme.success }}>
              ...
              <div style={{ padding: 12, background: theme.bgCard, borderRadius: 8, border: `1px solid ${theme.border}` }}>
                <div style={{ fontSize: 12, color: theme.textSecondary, marginBottom: 4 }}>주당</div>
                <div style={{ fontSize: 20, fontWeight: 700, color: theme.success }}>
              ...
              <div style={{ padding: 12, background: theme.bgCard, borderRadius: 8, border: `1px solid ${theme.border}` }}>
                <div style={{ fontSize: 12, color: theme.textSecondary, marginBottom: 4 }}>월당</div>
                <div style={{ fontSize: 20, fontWeight: 700, color: theme.success }}>
              ...
              <div style={{ padding: 12, background: theme.bgCard, borderRadius: 8, border: `1px solid ${theme.border}` }}>
                <div style={{ fontSize: 12, color: theme.textSecondary, marginBottom: 4 }}>연간</div>
                ...
                <div key={p.tokenId} style={{ border: `1px solid ${theme.border}`, borderRadius: 12, padding: 16, background: theme.bgSecondary }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                    <div>
                      ...
                      <div style={{ fontSize: 13, color: theme.textSecondary }}>포지션 #{p.tokenId}</div>
                    </div>
                  ...
                  {(p.estimatedAmount0 > 0 || p.estimatedAmount1 > 0) && (
                    <div style={{ marginBottom: 12, padding: '12px', background: theme.bgCard, borderRadius: 8, border: `1px solid ${theme.border}` }}>
                      <div style={{ fontSize: 12, color: theme.textSecondary, marginBottom: 6, fontWeight: 600 }}>보유 자산</div>
                  ...
                  {p.isStaked && (p.rewardRate || p.estimatedAPR) && (
                    <div style={{ marginBottom: 12, padding: '12px', background: theme.successBg, borderRadius: 8, border: `1px solid ${theme.successBorder}` }}>
                      <div style={{ fontSize: 12, color: theme.success, marginBottom: 6, fontWeight: 700 }}>🎁 스테이킹 보상</div>
                      {p.estimatedAPR && (
                      ...
                      {p.rewardRate && p.rewardPerYearUSD && (
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 8, marginTop: 8 }}>
                          <div>
                            <div style={{ fontSize: 11, color: theme.success, opacity: 0.8 }}>초당</div>
                          ...
                          <div>
                            <div style={{ fontSize: 11, color: theme.success, opacity: 0.8 }}>일당</div>
                            <div style={{ fontSize: 13, color: theme.success, fontWeight: 600 }}>
                          ...
                          <div>
                            <div style={{ fontSize: 11, color: theme.success, opacity: 0.8 }}>주당</div>
                            <div style={{ fontSize: 13, color: theme.success, fontWeight: 600 }}>
                          ...
                          <div>
                            <div style={{ fontSize: 11, color: theme.success, opacity: 0.8 }}>연간 (USD)</div>
                            <div style={{ fontSize: 13, color: theme.success, fontWeight: 600 }}>
                  ...
                  {cur !== undefined && (
                    <div style={{ marginBottom: 12 }}>
                      <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 8 }}>
                        <div style={{ fontSize: 12, color: theme.textSecondary, fontWeight: 600 }}>현재 가격</div>
                        <button
                  ...
                  {(rMin !== undefined && rMax !== undefined) && (
                    <div style={{ padding: '12px', background: darkMode ? '#1a3a52' : '#e3f2fd', borderRadius: 8, marginBottom: 12 }}>
                      <div style={{ fontSize: 12, color: theme.primary, marginBottom: 6, fontWeight: 600 }}>가격 범위</div>
                  ...
                  <details style={{ marginTop: 12, fontSize: 12, color: theme.textSecondary }}>
                    <summary style={{ cursor: 'pointer', userSelect: 'none' }}>상세 정보</summary>
